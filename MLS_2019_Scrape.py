...
hyperlinkTEXTS = BIG_beautifulsoup.find_all('tbody')[4].find_all(href = re.compile('squads'))  # THEN 5th TABLE after 2 * OVERALL, 2 * HOME/AWAY. # '(href = re.compile('squads'))' narrows JUST LIKE '.find('a')'.
