...
hyperlinkTEXTS = BIG_beautifulsoup.find_all('tbody')[10].find_all(href = re.compile('squads'))  # THEN 11th TABLE after 2 * OVERALL, 2 * HOME/AWAY, and then GROUPS A through F. # '(href = re.compile('squads'))' narrows JUST LIKE '.find('a')'.
